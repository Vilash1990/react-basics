...
const headCells = [
  ...
  { id: "street", numeric: false, disablePadding: true, label: "Street Name" },
...
function RandomUsersTableHead(props) {
  const {
    classes,
    onSelectAllClick,
    order,
...
RandomUsersTableHead.propTypes = {
